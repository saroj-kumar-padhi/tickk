class BuyerInprocessResponseModel {
  final bool success;
  final List<Data> data;

  BuyerInprocessResponseModel({required this.success, required this.data});

  factory BuyerInprocessResponseModel.fromJson(Map<String, dynamic> json) {
    return BuyerInprocessResponseModel(
...
class Data {
  ...
  final String date; // Store the formatted date string
