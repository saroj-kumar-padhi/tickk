            ...
            body: SafeArea(
              child: Column(
                children: [
                    ...
                    return SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          // Sort the categories
                          List<MapEntry<String, String>> sortedCategories =
                              flavourContoler.categoryData.entries.toList()
                                ..sort((a, b) {
                          ...
                          String categoryName = sortedCategories[index].key;
                          String imagePath = sortedCategories[index].value;
                          bool isEnabled = categoriesController.categories
                            ...
                            onTap: isEnabled
                                ? () async {
                                    ...
                                    await categoriesController
                                        .fetchSubcategories(categoriesController
                                            .selectedCategory
                                            .value = categoryName);
                  ...
                  SizedBox(
                    height:
                        4.h, // Adjust spacing between search bar and tab bar
                  ),
                  SizedBox(
