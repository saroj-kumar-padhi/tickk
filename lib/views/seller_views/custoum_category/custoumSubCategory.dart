...
class CustoumSubCategory extends StatelessWidget {
  CustoumSubCategory({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            SetUpProduct.subCategorySelectController.clearAllSelection();
            Get.back();
          },
          icon: const Icon(
            Icons.arrow_back,
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: const SmallHeading(headingText: "Add product categories"),
          ),
          coustoumTextField(
            ...
            child: Buttons.longButton(
                ...
                onPressedCallback: () {
                  if (nameController.text.isEmpty ||
                      addProductController.text.isEmpty) {
