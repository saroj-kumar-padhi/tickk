...
class CustoumSubSubCategory extends StatelessWidget {
  ...
  final TextEditingController addProductSubController = TextEditingController();

  final MultiSelectController categorySelectController =
      MultiSelectController();
  final MultiSelectController addProductController = MultiSelectController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            SetUpProduct.subSubCategorySelectController.clearAllSelection();
            Get.back();
          },
          icon: const Icon(
            Icons.arrow_back,
      ...
      body: Column(
        children: [
          ...
          Padding(
            padding: EdgeInsets.only(left: 20.w),
            child: const SmallHeading(headingText: "Select Store Categories"),
          ),
          Padding(
          ...
          Padding(
            ...
            child: const SmallHeading(headingText: "Select product categories"),
          ),
          Padding(
            padding: EdgeInsets.symmetric(horizontal: 20.w),
            child: MultiSelectDropDown(
              ...
              // options: const [],
              options: const <ValueItem>[
                ValueItem(label: 'Categories 1', value: '1'),
                ValueItem(label: 'Categories 2', value: '2'),
                ValueItem(label: 'Categories 3', value: '3'),
              ],
              maxItems: 3,
          ...
          Padding(
            padding: EdgeInsets.only(left: 20.w),
            child:
                const SmallHeading(headingText: "Add product Sub categories"),
          ),
          coustoumTextField(
              controller: addProductSubController,
            ...
            child: Buttons.longButton(
                ...
                onPressedCallback: () {
                  if (nameController.text.isEmpty ||
                      addProductSubController.text.isEmpty) {
