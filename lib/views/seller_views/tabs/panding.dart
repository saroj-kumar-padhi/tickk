    ...
    return Obx(() => sellerpandingcontroller.isLoading.value
        ...
        : Column(
            children: [
              Expanded(
                flex: 12,
                child: sellerpandingcontroller.requirementsList.isEmpty
                    ? Center(
                        child: Column(
                    ...
                    : ListView.builder(
                        itemCount:
                            sellerpandingcontroller.requirementsList.length,
                        itemBuilder: (context, index) {
                          Data data = sellerpandingcontroller
                              .requirementsList.value[index];
                          return Padding(
